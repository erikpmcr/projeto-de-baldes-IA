...
public class WidthSearch : MonoBehaviour
{
    ...
    [SerializeField]
    public Queue<BucketStateNode> WidthSearchQueue = new Queue<BucketStateNode>();
    [SerializeField]
    ...
    public void trueSearch(Queue<BucketStateNode> q, Vector2 result)
    {
        if (q.Count != 0)
        {
            BucketStateNode cur;
